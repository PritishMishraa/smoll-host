...
export function FileUploader(props: FileUploaderProps) {
    ...
    const onDrop = React.useCallback(
        (acceptedFiles: File[], rejectedFiles: FileRejection[]) => {
            ...
            if ((multiple || maxFiles > 1) && (files?.length ?? 0) + acceptedFiles.length > maxFiles) {
            ...
            const updatedFiles = !multiple && maxFiles === 1
                ? newFiles.slice(0, 1)
                : files
                    ? [...files, ...newFiles]
                    : newFiles
    ...
    const descriptionIds = inlineError ? `${instructionsId} ${errorId}` : instructionsId
    ...
    return (
        <div className="relative flex flex-col gap-4 overflow-hidden">
            ...
            >
                {({ getRootProps, getInputProps, isDragActive }) => (
                    <div
                        ...
                        {...dropzoneProps}
                    >
                        <input {...getInputProps({ "aria-label": "Upload HTML file" })} />
                        {selectedFile ? (
                            <div className="flex flex-col items-center justify-center gap-3 sm:px-5 py-6">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p id={instructionsId} className="text-sm text-default-500">
                            ...
                            <div className="flex flex-col items-center justify-center gap-4 sm:px-5 py-10">
                                ...
                                <p id={instructionsId} className="font-medium text-default-600">
            ...
            {inlineError && (
                <div id={errorId} className="flex items-center gap-2 rounded-lg bg-danger-50 px-3 py-2 text-sm text-danger">
